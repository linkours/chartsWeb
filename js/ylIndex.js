	...
	$.fn.autocomplete = function(params) {
		...
		this.each(function() {
			var searchContainer = $('<div></div>')
				.addClass('inputBox indexIpt')	
			var input = $('<input type="text" autocomplete="off" name="query">')
				.attr('placeholder','请输入搜索词').addClass('form-control indexSer');
			...
			if(params.showButton){
				var button = "<span class='glyphicon glyphicon-search search-btn head_search' aria-hidden='true'></span>";
